...
# Annual files
file_annual1_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_trend_annual.nc')
file_annual2_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_pval_annual.nc')
trend_annual_high = file_annual1_high['trend']/3.5
pval_annual_high = file_annual2_high['p_val']

# DJF files
file_djf1_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_trend_djf.nc')
file_djf2_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_pval_djf.nc')
trend_djf_high = file_djf1_high['trend']/3.5
pval_djf_high = file_djf2_high['p_val']

# MAM files
file_mam1_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_trend_mam.nc')
file_mam2_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_pval_mam.nc')
trend_mam_high = file_mam1_high['trend']/3.5
pval_mam_high = file_mam2_high['p_val']

# JJA files
file_jja1_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_trend_jja.nc')
file_jja2_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_pval_jja.nc')
trend_jja_high = file_jja1_high['trend']/3.5
pval_jja_high = file_jja2_high['p_val']

# SON files
file_son1_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_trend_son.nc')
file_son2_high = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_high/temp_high_pval_son.nc')
...
# Annual files
file_annual1_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_trend_annual.nc')
file_annual2_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_pval_annual.nc')
trend_annual_low = file_annual1_low['trend']/3.5
pval_annual_low = file_annual2_low['p_val']

# DJF files
file_djf1_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_trend_djf.nc')
file_djf2_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_pval_djf.nc')
trend_djf_low = file_djf1_low['trend']/3.5
pval_djf_low = file_djf2_low['p_val']

# MAM files
file_mam1_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_trend_mam.nc')
file_mam2_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_pval_mam.nc')
trend_mam_low = file_mam1_low['trend']/3.5
pval_mam_low = file_mam2_low['p_val']

# JJA files
file_jja1_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_trend_jja.nc')
file_jja2_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_pval_jja.nc')
trend_jja_low = file_jja1_low['trend']/3.5
pval_jja_low = file_jja2_low['p_val']

# SON files
file_son1_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_trend_son.nc')
file_son2_low = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval/temp_low_pval_son.nc')
...
# Annual files
file_annual1_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_trend_annual.nc')
file_annual2_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_pval_annual.nc')
trend_annual_mitigation = file_annual1_mitigation['trend']/3.5
pval_annual_mitigation = file_annual2_mitigation['p_val']

# DJF files
file_djf1_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_trend_djf.nc')
file_djf2_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_pval_djf.nc')
trend_djf_mitigation = file_djf1_mitigation['trend']/3.5
pval_djf_mitigation = file_djf2_mitigation['p_val']

# MAM files
file_mam1_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_trend_mam.nc')
file_mam2_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_pval_mam.nc')
trend_mam_mitigation = file_mam1_mitigation['trend']/3.5
pval_mam_mitigation = file_mam2_mitigation['p_val']

# JJA files
file_jja1_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_trend_jja.nc')
file_jja2_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_pval_jja.nc')
trend_jja_mitigation = file_jja1_mitigation['trend']/3.5
pval_jja_mitigation = file_jja2_mitigation['p_val']

# SON files
file_son1_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_trend_son.nc')
file_son2_mitigation = xr.open_dataset('C:/python_work/phd/paper5/real_work/phase2/trends_and_pval_mitigation/temp_mitigation_pval_son.nc')
...
divnorm = colors.TwoSlopeNorm(vmin=-0.0165, vcenter=0, vmax=0.0165)

" SSP3-7.0 "
ax = plt.subplot(5,3,1, projection=ccrs.PlateCarree())
plt.pcolormesh(file_annual1_high['lon'], file_annual1_high['lat'], trend_annual_high, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_djf1_high['lon'], file_djf1_high['lat'], trend_djf_high, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_mam1_high['lon'], file_mam1_high['lat'], trend_mam_high, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_jja1_high['lon'], file_jja1_high['lat'], trend_jja_high, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_son1_high['lon'], file_son1_high['lat'], trend_son_high, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_annual1_low['lon'], file_annual1_low['lat'], trend_annual_low, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_djf1_low['lon'], file_djf1_low['lat'], trend_djf_low, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_mam1_low['lon'], file_mam1_low['lat'], trend_mam_low, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_jja1_low['lon'], file_jja1_low['lat'], trend_jja_low, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_son1_low['lon'], file_son1_low['lat'], trend_son_low, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_annual1_mitigation['lon'], file_annual1_mitigation['lat'], trend_annual_mitigation, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_djf1_mitigation['lon'], file_djf1_mitigation['lat'], trend_djf_mitigation, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_mam1_mitigation['lon'], file_mam1_mitigation['lat'], trend_mam_mitigation, cmap='bwr', norm=divnorm)
...
plt.pcolormesh(file_jja1_mitigation['lon'], file_jja1_mitigation['lat'], trend_jja_mitigation, cmap='bwr', norm=divnorm)
...
last_plot = plt.pcolormesh(file_son1_mitigation['lon'], file_son1_mitigation['lat'], trend_son_mitigation, cmap='bwr', norm=divnorm)
...
cb = plt.colorbar(last_plot, cb_axes,
                   label="Sen's slope ($\mathregular{^o}$C $\mathregular{decade^{-1}}$)", 
